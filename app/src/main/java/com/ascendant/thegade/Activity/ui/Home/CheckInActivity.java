...
public class CheckInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Declaration();
        if(EasyPermissions.hasPermissions(CheckInActivity.this, galleryPermissions)) {
            Toast.makeText(this, "Permission Granted", Toast.LENGTH_SHORT).show();
        }else{
            EasyPermissions.requestPermissions(CheckInActivity.this, "Access for storage",
...
//                    imageView.setImageBitmap(BitmapFactory.decodeFile(mediaPath));
            ...
            Camera.setImageBitmap(BitmapFactory.decodeFile(mediaPath));
            Gambar = false;
